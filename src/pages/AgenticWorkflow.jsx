...
export const AgenticWorkflow = () => {
    ...
    return (
        <section className="relative min-h-screen py-32 px-6 overflow-hidden bg-black text-zinc-300 font-sans selection:bg-orange-500/20 selection:text-orange-200">
            {/* Background Decorations */}
            <div className="absolute top-0 left-0 w-full h-[500px] bg-[radial-gradient(ellipse_at_top,_var(--accent-glow,rgba(251,146,60,0.15)),_transparent_70%)] pointer-events-none"></div>
            ...
            <SEO
                ...
                description="Bridge semantic intent to physical execution. Calabi's RTSM acts as the shared source of truth, enabling agents to query, plan, and act in the real world."
            />
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <header className="mb-24 relative">
                    ...
                    <div className="text-center mt-12 md:mt-24 md:text-left">
                        <h1 className="text-5xl md:text-7xl font-heading font-medium text-white tracking-tighter mb-6 animate-fade-in opacity-0 [animation-delay:0.1s] leading-[1.1]">
                            From Intent to <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-white to-orange-400">Physical Action.</span>
                        </h1>
                ...
                <div className="animate-fade-in opacity-0 [animation-delay:0.3s]">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-[#0A0A0A] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
                                ...
                                {/* Terminal Content */}
                                <div className="p-6 font-mono text-sm h-[600px] overflow-hidden flex flex-col">
